"use strict";
const EventEmitter = require('events').default || require('events');
const { WAMessageStatus } = require('../Types/index.js');
const { trimUndefined } = require('./generics.js');
const { updateMessageWithReaction, updateMessageWithReceipt } = require('./messages.js');
const { isRealMessage, shouldIncrementChatUnread } = require('./process-message.js');
