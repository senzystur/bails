...
const { NOISE_MODE, WA_CERT_DETAILS } = require('../Defaults/index.js');
const { decodeBinaryNode } = require('../WABinary/index.js');
const { aesDecryptGCM, aesEncryptGCM, Curve, hkdf, sha256 } = require('./crypto.js');
const IV_LENGTH = 12;
